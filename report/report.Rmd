...
X.train <- model.matrix(formula_train, data = X,
                        contrasts.arg = lapply(X[,1:5], contrasts, contrasts=FALSE))
...
stanFile <- file.path("C:","Users","alpgu","Dropbox","Data Science","Bayesian Data Analysis","BDA3 (Gelman)","titanic","scripts","multivariate_hier_model.stan")
