...
pp_check(multi_hier1_title_post.fit, type = "stat_2d")
pp_check(multi_hier1_title_post.fit, type = "violin_grouped", group = "title")
pp_check(multi_hier1_title_post.fit, type='error_scatter_avg')
...
loo2 <- loo::loo(population_all.fit, save_psis = TRUE, cores = 4)
loo3 <- loo::loo(population_all_hs.fit, save_psis = TRUE, cores = 4)
loo4 <- loo::loo(population_and_group_intercept.fit, save_psis = TRUE, cores = 4)
loo5 <- loo::loo(multi_hier1_title_post.fit, save_psis = TRUE, cores = 4)
loo6 <- loo::loo(multi_hier2_pClass_post.fit, save_psis = TRUE, cores = 4, moment_match = T)
...
ppc_loo_pit_overlay(
  y = y.train,
  yrep = yrep5.posterior,
  lw = weights(loo5$psis_object),
  boundary_correction = T
)

ppc_loo_pit_overlay(
  y = y.train,
  yrep = yrep6.posterior,
  lw = weights(loo6$psis_object),
  boundary_correction = T
)
```
