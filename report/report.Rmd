...
```{r data summary, cache=TRUE, echo=FALSE}
summary(dat.full)
str(dat.full)
```
...
```{r visual check with available data1, cache=TRUE, eval=FALSE, echo=FALSE}
...
```{r visual check with available data2, cache=TRUE, eval=FALSE, echo=FALSE}
