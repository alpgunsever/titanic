...
set.seed(187)
# Replacing the survival variable with random binomial to be able to compare them with null model
train_imp_ppc <- train_imp %>% select(-c(PassengerId, Survived))
n <- nrow(train_imp_ppc)
train_imp_ppc$Survived_ppc <- rbinom(n,1,0.5)
