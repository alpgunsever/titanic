...
```{r model fitting, cache=TRUE, eval=TRUE, echo=FALSE}
title <- titleTrain
...
multi_hier3_Cabin_post.fit <- brm(formula = formula_hier3_Cabin,
                                       ...
                                       save_pars = save_pars(all = TRUE),
                                       seed = 187)
# model 8: All predictors model with population and group effects by Cabin: no covariance matrix------
multi_hier4_Cabin_noCov_post.fit <- brm(formula = formula_hier3_Cabin,
                                       data = df3.train,
                                       prior = prior0,
                                       family = bernoulli(link="logit"),
                                       cores = parallel::detectCores(),
