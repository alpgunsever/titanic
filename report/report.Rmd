...
```{r visual check with available data3, cache=TRUE, eval=FALSE, echo=FALSE}
...
```{r visual check with available data4, cache=TRUE, eval=FALSE, echo=FALSE}
...
brms::loo_compare(loo1,loo2,loo3,loo4,loo5,loo6,loo7,loo8,loo9,loo10,loo11)

# using list of loo objects
loo_list <- list(loo1,loo2,loo3,loo4,loo5,loo6,loo7,loo8,loo9,loo10, loo11)
...
probs_all <- brms::pp_average(only_population_intercept.fit,population_all.fit,population_all_hs.fit,
                          ...
                          multi_hier3_doubleClass.fit,multi_hier4_doubleClass.fit,
