...
Initially we will plot the posterior predictive distribution simulations below and compare it with the actual reponse variable distribution like we did in the prior predictive check section:

```{r posterior predictive checking 1, cache=TRUE, eval=TRUE, echo=FALSE, fig.height = 2.5, message=FALSE}
pp1 <- pp_check(y.train, yrep1.posterior, ppc_dens_overlay) + labs(title = "Model1")
```

```{r posterior predictive checking 2, cache=TRUE, eval=TRUE, echo=FALSE, fig.height = 2.5, message=FALSE}
pp2 <- pp_check(y.train, yrep2.posterior, ppc_dens_overlay) + labs(title = "Model2")
```

```{r posterior predictive checking 3, cache=TRUE, eval=TRUE, echo=FALSE, fig.height = 2.5, message=FALSE}
pp3 <- pp_check(y.train, yrep3.posterior, ppc_dens_overlay) + labs(title = "Model3")
```

```{r posterior predictive checking 4, cache=TRUE, eval=TRUE, echo=FALSE, fig.height = 5, message=FALSE}
pp4 <- pp_check(y.train, yrep4.posterior, ppc_dens_overlay) + labs(title = "Model4")
...
pp5 <- pp_check(y.train, yrep5.posterior, ppc_dens_overlay) + labs(title = "Model5")
```

```{r posterior predictive checking 6, cache=TRUE, eval=TRUE, echo=FALSE, fig.height = 2.5, message=FALSE}
pp6 <- pp_check(y.train, yrep6.posterior, ppc_dens_overlay) + labs(title = "Model6")
```

```{r posterior predictive checking 7, cache=TRUE, eval=TRUE, echo=FALSE, fig.height = 5, message=FALSE}
pp7 <- pp_check(y.train, yrep7.posterior, ppc_dens_overlay) + labs(title = "Model7")

grid.arrange(pp5,pp6,pp7, ncol=2)
```

```{r posterior predictive checking 8, cache=TRUE, eval=FALSE, echo=FALSE}
...
pp_check(y.train, yrep7.posterior, fun = "stat_grouped", group = train_imp$Cabin, stat = "mean")
