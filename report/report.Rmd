...
```{r final transformation 1, cache=TRUE, echo=FALSE, fig.height = 2.5, message=FALSE, warning=FALSE}
aggr(dat.full, numbers=TRUE, prop = c(TRUE,FALSE))
```


We will start by by replacing them with median of each title group that the individual belongs to.

```{r visual check with available data19, cache=TRUE, eval=FALSE, echo=FALSE}
