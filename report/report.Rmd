...
y_pred3.hier <- posterior_predict(model3_fit_hier_pClass, df3.test, draws = 500)
...
write.csv(x = model3_hier.submission, file = file.path("C:","Users","alpgu","Dropbox","Data Science",                                             "Bayesian Data Analysis","BDA3 (Gelman)","titanic","submissions","model3_hier_pClass.csv"),
          row.names = FALSE)
```
