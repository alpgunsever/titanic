...
The next two graphs show the family size relationship to survival rate:
...
```{r visual check with available data11, cache=TRUE, eval=FALSE, echo=FALSE}
...
```{r visual check with available data12, cache=TRUE, eval=FALSE, echo=FALSE}
