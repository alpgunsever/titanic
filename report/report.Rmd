...
Another step to take before getting into data imputation is to look at the available data visually. As a starting point to that, the first plot on below left shows the average age for each title. The one on the right shows the number of observations for each title:
...
The survival rate is proportional to the passenger class with passengers that pay the highest price survive the most proportionally. 

```{r visual check with available data7, cache=TRUE, eval=FALSE, echo=FALSE}
...
```{r visual check with available data8, cache=TRUE, eval=FALSE, echo=FALSE}
