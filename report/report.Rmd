...
```{r posterior predictive checking 15, cache=TRUE, eval=FALSE, echo=FALSE}
...
The mean and standard deviations of the models seem to have converged to mimic the response variable distribution. So we can switch to the next section where we try to improve the models as well as creating new ones.
