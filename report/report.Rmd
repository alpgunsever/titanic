...
mcmc_areas(as.matrix(model2_fit_hier_ticket)[,1:length(colnames(df2.train))])
```
...
write.csv(x = model1_hier.submission, file = file.path("C:","Users","Alp","Dropbox","Data Science",                                             "Bayesian Data Analysis","BDA3 (Gelman)","titanic","submissions","model1_hier_pClass.csv"),
          row.names = FALSE)
